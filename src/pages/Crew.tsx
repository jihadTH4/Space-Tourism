  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: 'url(/assets/crew/background-crew-mobile.jpg)' }}
      >
        <main className="flex-1 flex flex-col lg:flex-row pt-[88px] md:pt-[136px] lg:pt-[212px] px-6 md:px-[38px] lg:px-[165px] pb-0 lg:pb-0">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:flex-1 order-2 lg:order-1">
            ...
            {/* Crew role & name */}
            <div className="mt-8 md:mt-12 lg:mt-[154px]">
              <p
            ...
            <p
              key={`bio-${activeIndex}`}
              className="text-[#D0D6F9] text-[15px] md:text-[16px] lg:text-[18px] leading-[25px] md:leading-[28px] lg:leading-[32px] mt-4 md:mt-6 max-w-[444px] font-sans animate-fade-in-up delay-100"
            >
              {current.bio}
            </p>

            {/* Dot navigation */}
            <div className="mt-8 md:mt-10 lg:mt-auto lg:mb-[94px]">
              <DotNav
                count={crew.length}
          ...
          <div className="flex justify-center lg:justify-end lg:items-end order-1 lg:order-2 mt-8 md:mt-10 lg:mt-0 lg:flex-1">
            ...
            <div className="md:hidden absolute left-6 right-6 h-px bg-[#383B4B] bottom-[88px]" />
            ...
            <picture>
              ...
              <img
                ...
                alt={current.name}
                className="w-[177px] md:w-[456px] lg:w-auto lg:max-h-[712px] object-contain object-bottom border-b border-[#383B4B] md:border-none animate-fade-in"
              />
            </picture>
          </div>
        </main>
